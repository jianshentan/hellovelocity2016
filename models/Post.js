...
Post.add(
  ...
  "Content",
  {
    ...
    content: {
      ...
      extended: { type: Types.Html, wysiwyg: true, height: 600, label: "Main blog text. NOTE: headers must be put into <h1> tags, and regular text must be put within <p> tags" }
    },
  },
  "Categories",
  {
